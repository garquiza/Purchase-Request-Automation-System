    ...
    <div class="content animate__animated animate__fadeIn">
        ...
        <div class="table-container">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <div>
                    <span class="total-number">Total Number: ##</span>
                </div>
                ...
                <tbody id="ppmp-table">
                            <td class="text-justify">
                                <div class="btn-group" role="group" aria-label="Actions">
                                    <a href="download_ppmp.php?ppmp_id=" class="btn btn-outline-primary btn-sm" title="Download PPMP" style="margin-right: 5px;">
                                        <i class="fas fa-download"></i>
                                    </a>
                                    <a href="view_ppmp.php?ppmp_id=" class="btn btn-outline-info btn-sm" title="View PPMP" style="margin-right: 5px;">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="update_ppmp.php?ppmp_id=" class="btn btn-outline-warning btn-sm" title="Update PPMP" style="margin-right: 5px;">
